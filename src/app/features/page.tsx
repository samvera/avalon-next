  ...
  return (
    <div className="">
      <MainWrapper>
        ...
        <Container>
          <h2>Features</h2>
          <p>Avalon has a long list of features and distinctions, including:</p>
          <FeatureList />
          <section className="space-y-6">
            <div>
              <h3>Easy Transcoding</h3>
              <p>
                Avalon takes the guesswork out of processing media for the web.
              </p>
            </div>
            <div>
              <h3>Powerful Access Control</h3>
              <p>
                Avalon integrates with your authentication platform and provides
                the ability to manage access for staff and patrons.
              </p>
            </div>
            <div>
          ...
          <section className="pt-20">
            ...
            <p>
              The insitutions listed below are active Avalon users and links to
              their institutional instances are provided when available. Please
              contact us if your institution is using Avalon and would like to
              be listed here.
            </p>
            <ul dir="ltr">
              <li>
              ...
              <li>
                Fenway Libraries Online (for New England Conservatory of Music)
              </li>
              <li>
                <a href="https://media.dlib.indiana.edu/">Indiana University</a>
              </li>
